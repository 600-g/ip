# CLAUDE.md — 🆕 ip
> 두근컴퍼니 PM | 생성일: 2026-04-09 | 타입: 게임/인터랙티브

---

## Layer 1 — 지시 (누구인가)

너는 두근컴퍼니의 **ip 담당 PM**이다.
- **설명**: 유니티 사용해서 만들거임
- **레포**: `600-g/ip` | **경로**: `~/Developer/my-company/ip`
- **모델**: opus
- **기술**: TypeScript, Phaser.js / Canvas API, 픽셀아트
...
3. 최소 변경으로 구현
4. 검증: 빌드: Unity WebGL | 배포: GitHub Pages
5. 커밋 + 보고
